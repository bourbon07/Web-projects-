...
export function Login() {
  ...
  const validate = () => {
    ...
    if (mode === "register" && form.password !== form.password_confirmation) newErrors.password_confirmation = t("كلمة المرور غير متطابقة", "Passwords do not match");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (mode === "login") {
        ...
        formData.append("gender", form.gender === "ذكر" ? "male" : "female");
      ...
      const msg = err.response?.data?.message || t("حدث خطأ ما", "Something went wrong");
  ...
  const handleGoogleLogin = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      ...
      try {
        ...
        alert(t("فشل تسجيل الدخول بواسطة جوجل", "Google Login Failed"));
      } finally {
        setLoading(false);
      }
    },
    onError: () => alert(t("فشل تسجيل الدخول بواسطة جوجل", "Google Login Failed")),
  });
    ...
    >
      ...
      <div className="flex-1 flex items-center justify-center p-6 overflow-y-auto" style={{ background: c.bg }}>
        ...
        >
          ...
          {/* Mode Toggle */}
          <div className="flex rounded-2xl p-1 mb-6" style={{ background: c.surface3 }}>
            {[
              ...
              <button
                ...
                style={{
                  ...
                  color: mode === m.key ? "white" : c.muted,
                  fontWeight: 700,
                  fontSize: "14px",
                  fontFamily: "'Cairo', sans-serif",
                }}
          ...
          <h2 className="mb-5" style={{ fontWeight: 800, color: c.text, fontSize: "22px" }}>
          ...
          >
            ...
            <span style={{ fontFamily: "'Cairo', sans-serif", fontWeight: 600, fontSize: "14px", color: c.text }}>
          ...
          >
            ...
            <span style={{ fontFamily: "'Cairo', sans-serif", fontWeight: 600, fontSize: "14px", color: c.text2 }}>
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span style={{ color: c.muted, fontSize: "13px" }}>{t("أو", "or")}</span>
            <div className="flex-1 h-px" style={{ background: c.border }} />
          </div>

          <form onSubmit={handleSubmit} className="space-y-4">
            {errors.submit && (
              <div className="p-3 rounded-xl bg-red-50 text-red-500 text-sm text-center border border-red-100 mb-4">
                {errors.submit}
              </div>
            )}
            {mode === "register" && (
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder={t("أعد كتابة كلمة المرور", "Confirm your password")}
                  />
                </div>
                {errors.password_confirmation && <p style={{ color: "#E5233B", fontSize: "12px", marginTop: "4px" }}>{errors.password_confirmation}</p>}
              </div>
            )}
            ...
            {mode === "login" && (
              <div className={lang === "ar" ? "text-left" : "text-right"}>
                <Link to="/forgot-password" style={{ color: "#E5233B", fontSize: "13px" }}>
          ...
          <p className="text-center mt-5" style={{ fontSize: "13px", color: c.muted }}>
