        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                { label: t("الصفحة الرئيسية", "Home"), path: "/" },
                { label: t("المنتجات", "Products"), path: "/#products" },
                { label: t("الباقات المجمعة", "Bundle Packages"), path: "/#packages" },
                { label: t("طلباتي", "My Orders"), path: "/orders" },
                { label: t("المفضلة", "Wishlist"), path: "/wishlist" },
              ].map((link) => (
                <li key={link.label}>
                  <a 
                    href={link.path} 
