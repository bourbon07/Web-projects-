            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3">
              {cart.length === 0 ? (
                ...
                cart.map((item) => (
                  ...
                  >
                    <img src={item?.image_url} alt={lang === "ar" ? item?.name?.ar : item?.name?.en}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2">
                         ...
                         {typeof (item as any).stock !== 'undefined' && item.quantity > (item as any).stock && (
                            <span className="flex items-center gap-1 px-1.5 py-0.5 rounded-md" style={{ background: "#FEF2F2", color: "#EF4444", fontSize: "10px", fontWeight: 700, border: "1px solid #FECACA" }}>
                  ...
                  return (
                    <>
                      <button
                        ...
                        disabled={hasProblem}
                        className="w-full py-3.5 rounded-xl text-white flex items-center justify-center gap-2 transition-all hover:opacity-90 disabled:opacity-50 disabled:grayscale"
                        style={{ background: hasProblem ? "#888" : "linear-gradient(135deg, #E5233B, #FF6B8A)", fontFamily: "'Cairo', sans-serif", fontWeight: 700, fontSize: "14px", cursor: hasProblem ? "not-allowed" : "pointer" }}
                      >
